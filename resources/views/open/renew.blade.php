        ...
        <div class="row justify-content-md-center">
            <div class="col-6">
                ...
                <form method="POST" class="mt-3" action="{{route('regist.renew.post', ['id'=>$id, 'uniqcode'=>$uniqcode])}}">
                    ...
                    <h1 class="h3 mb-3 font-weight-normal">{{$definePassword[ 'renew_title' ]->title}}</h1>
                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {{ Form::text('email', "", ['id'=>'email', 'class'=>'form-control', 'placeholder'=>$definePassword[ 'renew_input' ]->text ])}}
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-4">
                            {{Form::submit($definePassword[ 'renew_button' ]->title, ['class'=>'btn btn-primary w-100'])}}
                        </div>
                    </div>
                </form>
            </div>
